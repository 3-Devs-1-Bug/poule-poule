      ...
      <div className='About'>
        ...
        <div className='About__Section'>
          ...
          <p>
            ...
            . Nous ne gagnons pas d'argent via cette version du jeu et cela
            n'est et ne sera pas notre objectif.
          </p>
          <p>
        ...
        <div className='About__Section'>
          ...
          <p>
            ...
            . Pour toute question, suggestion d'amélioration ou remontée de
            bugs, n'hésitez pas à nous contacter via les liens ci-dessus.
          </p>
          <p>
